This is Group 10's SWE Pizza Project.
To view your receipt, check receipt.txt AFTER completing your order.
To view customer data, check customers.txt.
If these files do not exists, they will be created in the same directory that PizzaProject.exe is being run out of when they are needed.
